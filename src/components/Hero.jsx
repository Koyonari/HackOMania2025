    ...
    return (
        <section className="relative min-h-screen w-full overflow-hidden bg-gradient-to-b from-white to-gray-50">
            ...
            <div className="container relative grid lg:grid-cols-2 place-items-center py-20 md:py-32 gap-10 mx-auto">
              ...
              <span
                  className="inline bg-gradient-to-r from-brand-primary to-accent-primary text-transparent bg-clip-text">
                BET
              </span>
                            <span className="text-text-primary">ter</span>{" "}
                            <span
                                className="inline bg-gradient-to-r from-accent-primary via-brand-primary to-accent-secondary text-transparent bg-clip-text">
                Help
              </span>
                        </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <Button
                            className="bg-brand-primary hover:bg-brand-primary/90 text-white font-medium px-8 py-6 text-lg">
                            Get Started
                        </Button>
